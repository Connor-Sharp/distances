...
class ISOLATE:
   ...
   isolateCount = 0 
   def __init__(self,isolate="",coltype="",contiglength=0, identifier="",database="",HNHcontig="",IMMcontig="",HNHSequence="",IMMSequence="",profiles=[],Species="",HNHstart=0,IMMstart=-1000000,HNHstop=-10000000,IMMstop=0, MATCH="FALSE", comments="", contig="", shortcontig=""):
